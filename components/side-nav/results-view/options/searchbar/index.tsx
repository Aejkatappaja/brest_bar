  ...
  return (
    <div className='relative flex flex-1 flex-shrink-0 items-center'>
      ...
      <input
        ...
        type='text'
        className='shadow-3d w-full rounded-3xl bg-grey from-[#c213c7] to-[#b063f2] py-[9px] pl-10 text-sm font-semibold tracking-wide outline-none  duration-700 placeholder:font-semibold placeholder:text-[#909090ae] focus:bg-slate-600/30 '
      />
    </div>
  );
};
