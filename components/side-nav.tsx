...
export const SideNav = ({ limit }: { limit: number }) => {
  return (
    <div className='z-5 custom-scrollbar h-full w-[80%] overflow-y-scroll bg-[#201f23] pb-4 scrollbar md:w-[490px]'>
      ...
      <EstablishmentsList limit={limit} />
